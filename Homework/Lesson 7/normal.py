...
class Class:
    def __init__(self, class_room, teacher_fullname):
...
class Student:
    def __init__(self, student_fullname, class_room, father, mother):
    ...
    def get_parents(self):
        return "Папа - {}, Мама - {}".format(self.father, self.mother)


class Teacher:
    def __init__(self, teacher_fullname, subject):
        self.teacher_fullname = teacher_fullname
...
if __name__ == '__main__':
    ...
    students = [Student('Петров В.П.', '5A', "Петров В.В.", "Петрова Г.И."),
            Student('Харламов Ф.Ф.', '5B', "Харламов Ф.В.", "Харламова И.Г."),
            Student('Назаров А.Г.', '5A', "Назаров Г.Д.", "Назарова Л.П."),
            Student('Христов П.П.', '5A', "Христов П.А.", "Христова Г.И.")]
    teachers = [Teacher('Пупкин В.В.', 'химия'),
            Teacher('Свитов В.И.', 'математика'),
            Teacher('Пирогов Д.В.', 'история'),
            Teacher('Михеев И.В.', 'физкультура', )]
    classes = [Class('5А', [teachers[0], teachers[2]]),
            Class('5B', [teachers[1], teachers[3]])]

    print("Список классов в школе: ")
    for number in classes:
        print(number.class_room)
